...
var WebSocketTransport = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this._accessTokenFactory) return [3 /*break*/, 2];
                    ...
                    case 2: return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            if (Utils_1.Platform.isNode) {
                                ...
                                if (cookies) {
                                    headers[HeaderNames_1.HeaderNames.Cookie] = "".concat(cookies);
                                }
                                // Only pass headers when in non-browser environments
                                webSocket = new _this._webSocketConstructor(url, undefined, {
                                    headers: __assign(__assign({}, headers), _this._headers),
                                });
                            }
                            if (!webSocket) {
                            ...
                            webSocket.onopen = function (_event) {
                                _this._logger.log(ILogger_1.LogLevel.Information, "WebSocket connected to ".concat(url, "."));
                            ...
                            webSocket.onerror = function (event) {
                                ...
                                _this._logger.log(ILogger_1.LogLevel.Information, "(WebSockets transport) ".concat(error, "."));
                            };
                            webSocket.onmessage = function (message) {
                                _this._logger.log(ILogger_1.LogLevel.Trace, "(WebSockets transport) data received. ".concat((0, Utils_1.getDataDetail)(message.data, _this._logMessageContent), "."));
                                if (_this.onreceive) {
                                    try {
    ...
    WebSocketTransport.prototype.send = function (data) {
        if (this._webSocket && this._webSocket.readyState === this._webSocketConstructor.OPEN) {
            this._logger.log(ILogger_1.LogLevel.Trace, "(WebSockets transport) sending data. ".concat((0, Utils_1.getDataDetail)(data, this._logMessageContent), "."));
    ...
    WebSocketTransport.prototype._isCloseEvent = function (event) {
