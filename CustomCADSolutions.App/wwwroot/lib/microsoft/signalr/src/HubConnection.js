...
var HubConnection = /** @class */ (function () {
    function HubConnection(connection, logger, protocol, reconnectPolicy) {
        ...
        this._freezeEventListener = function () {
            _this._logger.log(ILogger_1.LogLevel.Warning, "The page is being frozen, this will likely lead to the connection being closed and messages being lost. For more information see the docs at https://docs.microsoft.com/aspnet/core/signalr/javascript-client#bsleep");
        };
    ...
    HubConnection.prototype._invokeClientMethod = function (invocationMessage) {
        ...
        if (methods) {
            try {
                ...
                this._logger.log(ILogger_1.LogLevel.Error, "A callback for the method ".concat(invocationMessage.target.toLowerCase(), " threw error '").concat(e, "'."));
            }
            ...
            this._logger.log(ILogger_1.LogLevel.Warning, "No client method with the name '".concat(invocationMessage.target, "' found."));
        }
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        e_4 = _a.sent();
                        this._logger.log(ILogger_1.LogLevel.Information, "Reconnect attempt failed because of error '".concat(e_4, "'."));
                        if (this._connectionState !== HubConnectionState.Reconnecting) {
