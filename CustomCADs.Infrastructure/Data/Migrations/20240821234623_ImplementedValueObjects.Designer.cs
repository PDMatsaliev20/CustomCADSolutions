...
namespace CustomCADs.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240821234623_ImplementedValueObjects")]
    partial class ImplementedValueObjects
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomCADs.Domain.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("CustomCADs.Domain.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CustomCADs.Domain.Entities.Cad", b =>
                {
                    ...
                    b.HasOne("CustomCADs.Domain.Identity.AppUser", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("CustomCADs.Domain.Entities.Order", b =>
                {
                    b.HasOne("CustomCADs.Domain.Identity.AppUser", "Buyer")
                        .WithMany()
                    ...
                    b.HasOne("CustomCADs.Domain.Identity.AppUser", "Designer")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("CustomCADs.Domain.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CustomCADs.Domain.Identity.AppUser", null)
                        .WithMany()
