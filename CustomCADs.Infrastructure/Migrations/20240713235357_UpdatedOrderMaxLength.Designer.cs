...
namespace CustomCADs.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240713235357_UpdatedOrderMaxLength")]
    partial class UpdatedOrderMaxLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomCADs.Infrastructure.Data.Models.Cad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CustomCADs.Infrastructure.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomCADs.Infrastructure.Data.Models.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("CustomCADs.Infrastructure.Data.Models.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CustomCADs.Infrastructure.Data.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CustomCADs.Infrastructure.Data.Models.Cad", b =>
                {
                    b.HasOne("CustomCADs.Infrastructure.Data.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CustomCADs.Infrastructure.Data.Models.Identity.AppUser", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("CustomCADs.Infrastructure.Data.Models.Order", b =>
                {
                    b.HasOne("CustomCADs.Infrastructure.Data.Models.Identity.AppUser", "Buyer")
                        .WithMany()
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CustomCADs.Infrastructure.Data.Models.Cad", "Cad")
                        .WithMany("Orders")
                        .HasForeignKey("CadId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("CustomCADs.Infrastructure.Data.Models.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CustomCADs.Infrastructure.Data.Models.Identity.AppUser", null)
                        .WithMany()
