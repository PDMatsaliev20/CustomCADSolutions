        ...
        <div className="page">
            <div className="header">
                <div className="container">
                    <p className="title">Privacy Policy for CustomCADSolutions</p>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="tab-content translations-content-item en visible" id="en">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CustomCADSolutions.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to CustomCADSolutions, accessible from <a href="https://www.customcads.com" rel="external nofollow noopener" target="_blank">https://www.customcads.com</a></p>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <p>By email: <a href="mailto:customcads222@gmail.com" className="text-[#0452a5] underline">customcads222@gmail.com</a></p>
                            </li>
                            <li>
